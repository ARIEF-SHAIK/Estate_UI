            ...
            <div className="flex flex-col gap-6">
              <div className="flex bg-[#2C2C2C] p-2 rounded-full w-full max-w-md items-center">
                <input
                  ...
                  className="bg-transparent w-full px-4 text-gray-300 focus:outline-none text-sm"
                />
                <button
                  className="bg-[#1F1F1F] px-4 py-2 rounded-full text-xs md:text-sm whitespace-nowrap hover:bg-gray-700 transition"
              ...
              <h3 className="text-2xl md:text-3xl font-semibold leading-snug">
                Signup and start enjoying the
                <br />
                benefits today!
              </h3>

              <button
                className="bg-purple-700 hover:bg-purple-800 px-4 py-3 rounded-xl mt-2 text-sm font-medium w-fit cursor-pointer hover:scale-110 transition duration-300"
                onClick={() => alert("🎉 Soon to be launched!")}
              >
                Sign Up To Lilypads
              </button>
              ...
              <div className="flex flex-wrap items-center gap-4 mt-6 ">
                {[
                  ...
                  <img
                    ...
                    src={icon}
                    alt="icon"
                    className="w-10 md:w-14 hover:scale-110 transition duration-300"
                  />
                ))}
              </div>
            </div>
